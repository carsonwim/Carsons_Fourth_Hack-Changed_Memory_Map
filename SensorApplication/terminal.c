...
//
//extern const char aucCC3000_prefix[3];
//
////*****************************************************************************
////
...
//                        sendString("\r\nFirst Time Config Prefix changed to: ");
//                        sendString (prfStr);
//                        sendString("\r\n");
//                    }
//                    else
...
//    sendString("\r\n                First Time config info will be erased");
//    sendString("\r\nprfx [XXX] - changes FTC prefix to XXX");
//    sendString("\r\nstat - provides status information");
//    sendString("\r\n");
//    sendString("And Carson Is Happy!\r\n");
//    sendString("\r\n");
//}
//
//
